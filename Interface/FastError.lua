---- SETTING HERE ---- ---- ---- ---- ----
local nfont = "FONTS\\1.ttf" -- This is the font`s of all errors
local nfontsize = 20 -- This is Font Size
local nfontcolor = {1,1,0.3} -- This is Font color ({RED,GREEN,BLUE,ALPHA}, only values from 0 to 1), 1 is deff
local Yoffset = -130 -- "y" layout coordinate ("VERTICAL") - Zero starts from TOP-CENTER of ur monitor
...
local holdtime = 1.5 -- hold time (seconds)
local fadeintime = 0.08 -- fadein time (seconds)
local fadeouttime = 0.5 -- fade out time (seconds)
-------------------------------------------
...
local TextOne = FirstErrorFrame:CreateFontString(nil, "OVERLAY")
	...
	TextOne:SetFont(nfont,nfontsize,"OUTLINE")
...
local TextTwo = SecondErrorFrame:CreateFontString(nil, "OVERLAY")
	...
	TextTwo:SetFont(nfont,nfontsize,"OUTLINE")
