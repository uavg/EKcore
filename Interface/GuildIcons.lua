...
if not Blizzard_GuildUI then LoadAddOn("Blizzard_GuildUI") end

local categories = { "playerStatus", "guildStatus", "achievement", "tradeskill", "reputation" }
local icons = {
	"Interface\\Icons\\Warrior_Talent_Icon_Blitz",
	"Interface\\Icons\\Achievement_GuildPerk_Everyones a Hero_Rank2",
	"Interface\\Icons\\Ability_Warrior_InnerRage",
	"Interface\\Icons\\Achievement_GuildPerk_WorkingOvertime",
	"Interface\\Icons\\Achievement_GuildPerk_HonorableMention",
