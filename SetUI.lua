...
--[[ 其他待確認 ]]
   ...
   --SetCVar("targetStatusText", 1)               --目標
   --SetCVar("alternateResourceText", 1)          --特殊能量
...
--[[ 單位框架 ]]
   --[[SetCVar("useCompactPartyFrames", 1)          --使用團隊風格的隊伍框架
   ...
   SetCVar("raidFramesDisplayOnlyDispellableDebuffs", 0) --只顯示可驅散
   SetCVar("raidFramesHealthText", none) --HP值
   SetCVar("raidFramesHeight", 42)
